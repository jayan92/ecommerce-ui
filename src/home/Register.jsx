...
const Register = () => {
  ...
  const title = (
    <h2 className="title">
      Join on Day Long Free Workshop for <b>Advance</b> <span className="yellow-color">Mastering</span> <b>On Sales</b>
    </h2>
  );
  ...
  return (
    <section className="register-section padding-tb pb0">
