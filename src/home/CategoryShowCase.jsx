    ...
    <div className="course-section style-3 padding-tb">
      ...
      <div className="container">
        ...
        <div className="section-wrapper">
          <div className="row g-4 justify-content-left row-cols-xl-4 row-cols-lg-3 row-cols-md-2 row-cols-1 course-filter">
            {items.map((product) => {
              const { id, imgUrl, imgAlt, cate, title, brand, authorName, price } = product;
