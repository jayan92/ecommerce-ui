    ...
    <>
      ...
      <div className={`review-content ${reviewShow ? "review-content-show" : "description-show"}`}>
            ...
            <div className="review-form">
              ...
              <form action="action" className="row">
                ...
                <div className="col-md-12 col-12">
                  <textarea rows="8" type="text" name="message" placeholder="Type Here Message"></textarea>
                </div>
        ...
        <div className="description">
          <p>
            Lorem ipsum dolor sit amet, consectetur adipisicing elit. Voluptate quia exercitationem quibusdam, qui natus
            rem aliquam odit consequuntur ipsam magni porro soluta placeat minus perferendis saepe, sint voluptatum
            culpa impedit ducimus facere maiores! Quos omnis incidunt quod magni inventore perspiciatis. Illum suscipit
            non vel dicta totam itaque similique cum nihil.
          </p>
